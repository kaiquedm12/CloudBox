...
const messages = {
  "pt-BR": {
    ...
    clusterDashboard: "Painel do cluster",
    operationalDescription: "Capacidade, disponibilidade e alertas em tempo real.",
    refresh: "Atualizar",
    refreshing: "Atualizando...",
    onlineNodes: "Nós online",
    activeContainers: "Containers ativos",
    cpuUsage: "Uso de CPU",
    ramUsage: "Uso de RAM",
    diskUsage: "Uso de disco",
    activeAlerts: "Alertas ativos",
    used: "utilizado",
    clusterCapacity: "Capacidade online do cluster",
    alertsTitle: "Pontos que precisam de atenção",
    alertsDescription: "Nós indisponíveis ou com recursos em nível crítico.",
    healthyCluster: "Tudo funcionando normalmente",
    healthyClusterDescription: "Nenhum nó offline, superaquecido ou com recurso crítico.",
    offlineNodeAlert: "Nó offline",
    temperatureAlert: "Temperatura acima do limite seguro",
    cpuAlert: "CPU em nível crítico",
    ramAlert: "RAM em nível crítico",
    diskAlert: "Disco em nível crítico",
    viewAlerts: "Ver alertas",
    allNodes: "Todos",
    onlineNodesFilter: "Online",
    offlineNodesFilter: "Offline",
    alertsFilter: "Com alerta",
    searchNodes: "Buscar nó...",
    sortBy: "Ordenar nós",
    sortName: "Nome",
    sortHighestUsage: "Maior utilização",
    gridView: "Visualização em grade",
    listView: "Visualização em lista",
    noMatchingNodes: "Nenhum nó corresponde aos filtros.",
    ...
    confirmRemoveContainer: "Remover este container? Esta ação não pode ser desfeita.",
    stoppingAction: "Parando...",
    removingAction: "Removendo...",
    ...
    close: "Fechar",
    createSuccess: "Container agendado com sucesso",
    ...
    capacityError: "Não há nenhum nó online com CPU, RAM e disco suficientes para esta solicitação. Reduza os recursos ou tente novamente mais tarde.",
  ...
  en: {
    ...
    clusterDashboard: "Cluster dashboard", operationalDescription: "Capacity, availability, and alerts in real time.", refresh: "Refresh", refreshing: "Refreshing...",
    onlineNodes: "Online nodes", activeContainers: "Active containers", cpuUsage: "CPU usage", ramUsage: "RAM usage", diskUsage: "Disk usage", activeAlerts: "Active alerts", used: "used", clusterCapacity: "Online cluster capacity",
    alertsTitle: "Items requiring attention", alertsDescription: "Unavailable nodes or resources at a critical level.", healthyCluster: "Everything is running normally", healthyClusterDescription: "No offline, overheated, or critically constrained nodes.",
    offlineNodeAlert: "Node offline", temperatureAlert: "Temperature above the safe limit", cpuAlert: "CPU at critical level", ramAlert: "RAM at critical level", diskAlert: "Disk at critical level", viewAlerts: "View alerts",
    allNodes: "All", onlineNodesFilter: "Online", offlineNodesFilter: "Offline", alertsFilter: "With alerts", searchNodes: "Search nodes...", sortBy: "Sort nodes", sortName: "Name", sortHighestUsage: "Highest utilization", gridView: "Grid view", listView: "List view", noMatchingNodes: "No nodes match the filters.", clearFilters: "Clear filters", lastReading: "Last reading", utilization: "Utilization", containerSingular: "container", containerPlural: "containers", openMenu: "Open menu", closeMenu: "Close menu", confirmRemoveContainer: "Remove this container? This action cannot be undone.", stoppingAction: "Stopping...", removingAction: "Removing...",
    ...
    scheduler: "CloudBox scheduler", close: "Close", createSuccess: "Container scheduled successfully", imageAllocated: "Image", allocatedOnNode: "was allocated to node", selected: "selected", finish: "Done",
    ...
    capacityError: "There are no online nodes with enough CPU, RAM, and disk for this request. Reduce the requested resources or try again later.", requestFailed: "Unable to request the container.",
