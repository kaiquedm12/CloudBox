...
const messages = {
  "pt-BR": {
    ...
    invalidPorts: "Revise a configuração das portas.",
    portsAndAccess: "Portas e acesso",
    portsHelp: "A porta do host em branco é atribuída pelo Docker. Portas internas não são publicadas.",
    addPort: "Adicionar porta",
    noPublishedPorts: "Nenhuma porta publicada. O serviço ficará acessível apenas pela rede interna.",
    port: "Porta",
    internalPort: "Porta interna",
    optionalHostPort: "Porta do host (opcional)",
    automatic: "Automática",
    protocol: "Protocolo",
    exposure: "Exposição",
    internal: "Interna",
    optionalBindAddress: "IP de publicação (opcional)",
    removePort: "Remover porta",
    access: "Acesso",
    endpointAddress: "Endereço",
    localNodeAccess: "Acesso local ao nó.",
    accessUnavailable: "Acesso indisponível",
    openApplication: "Abrir aplicação",
    copyEndpoint: "Copiar endpoint",
    copied: "Copiado",
    copyFailed: "Não foi possível copiar",
    observedEndpoints: "Endpoints observados",
    offlineEndpoints: "Nó offline: endpoints preservados apenas para diagnóstico; ações de acesso estão desabilitadas.",
    waitingForEndpoints: "Aguardando a publicação das portas pelo nó.",
    runningWithoutEndpoint: "Em execução, sem endpoint observado.",
    noEndpoint: "Nenhum endpoint de acesso disponível.",
    advertisedAddress: "Endereço anunciado",
    advertisedAddressMissing: "não informado",
  },
  en: {
    ...
    invalidPorts: "Review the port configuration.", portsAndAccess: "Ports and access", portsHelp: "A blank host port is assigned by Docker. Internal ports are not published.", addPort: "Add port",
    noPublishedPorts: "No ports are published. The service will only be reachable through the internal network.", port: "Port", internalPort: "Internal port", optionalHostPort: "Host port (optional)", automatic: "Automatic",
    protocol: "Protocol", exposure: "Exposure", internal: "Internal", optionalBindAddress: "Publish IP (optional)", removePort: "Remove port", access: "Access", endpointAddress: "Address",
    localNodeAccess: "Local access on the node.", accessUnavailable: "Access unavailable", openApplication: "Open application", copyEndpoint: "Copy endpoint", copied: "Copied", copyFailed: "Unable to copy",
    observedEndpoints: "Observed endpoints", offlineEndpoints: "Node offline: endpoints are kept for diagnostics and access actions are disabled.", waitingForEndpoints: "Waiting for the node to publish ports.",
    runningWithoutEndpoint: "Running without an observed endpoint.", noEndpoint: "No access endpoint available.", advertisedAddress: "Advertised address", advertisedAddressMissing: "not provided",
  },
} as const;
